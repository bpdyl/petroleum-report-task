...
class IndexView(ListView):
    ...
    def get_context_data(self,**kwargs):
        ...
        try:
            ...
            context['error'] = "Something went wrong. Please check your internet connection"
            return context
...
class TotalSalesView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # 'SELECT petroleum_product, SUM(sale) AS total_sale FROM reports GROUP BY petroleum_product'
        print(sales.query)
        context['sales'] = sales
        return context 
